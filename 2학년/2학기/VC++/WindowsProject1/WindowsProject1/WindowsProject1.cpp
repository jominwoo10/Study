// D0902.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
...
int g_bold, bold;		// 1(5pt), 2(10pt), 3(15pt), 4(20pt)
int g_flag;
HPEN newPen, osPen;
#endif
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_LBUTTONUP:
	{
		...
		{
		case 1:         // 빨강
			newPen = CreatePen(PS_SOLID, bold, RGB(255, 0, 0));
			break;

		case 2:         // 녹색
			newPen = CreatePen(PS_SOLID, bold, RGB(0, 255, 0));
			break;

		case 3:         // 파랑
			newPen = CreatePen(PS_SOLID, bold, RGB(0, 0, 255));
			break;

		case 4:         // 노랑
			newPen = CreatePen(PS_SOLID, bold, RGB(255, 212, 0));
			break;

		case 5:         // 보라
			newPen = CreatePen(PS_SOLID, bold, RGB(128, 0, 128));
			break;

		case 6:         // 핑크
			newPen = CreatePen(PS_SOLID, bold, RGB(255, 192, 203));
			break;

		default:
			newPen = CreatePen(PS_SOLID, bold, RGB(0, 0, 0));
			break;
		}
